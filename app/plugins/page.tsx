...
const PLUGINS = [
  {
    ...
    description: "Full channel management suite. Auto-grants op/halfop/voice on join, enforces channel modes, manages timed bans, protects ops from being deopped, and optionally takes revenge on kicks.",
    commands: ["!op", "!deop", "!halfop", "!dehalfop", "!voice", "!devoice", "!kick", "!ban", "!unban", "!kickban", "!bans"],
    notes: "37 configurable options including auto_op, enforce_modes, rejoin_on_kick, and ChanServ awareness.",
  },
  {
    name: "flood",
    tagline: "Inbound flood protection",
    description: "Tracks message, join, and nick-change rates per user using sliding windows. Escalates enforcement from warn to kick to timed ban. Ops can be exempted.",
    commands: [],
    notes: "Automatic — no commands. Configurable thresholds, windows, ban duration, and action sequence.",
  },
  {
    name: "greeter",
  ...
  },
  {
    ...
    description: "Records the last time a nick was active in a channel — message content, channel, and timestamp. Reports relative times (e.g. '5m ago', '3h 20m ago').",
    commands: ["!seen <nick>"],
    notes: "Persistent via SQLite. Configurable max age (default 365 days). Auto-cleans stale entries hourly.",
  },
  {
    name: "topic",
    tagline: "Color-coded themed topics",
    description: "Sets channel topics with IRC color-code themed borders. Includes topic protection — restores the topic if changed by a non-op. 10+ built-in themes.",
    commands: ["!topic <theme> <text>", "!topic preview <theme> <text>", "!topic lock", "!topic unlock", "!topics", "!topics preview"],
  ...
  },
  {
    ...
    description: "Automatically replies to CTCP VERSION, PING, and TIME requests. Reads the version string from package.json.",
    commands: [],
  ...
  },
  {
    ...
    description: "Responds to questions with one of 20 affirmative, 5 non-committal, or 5 negative responses. The classic IRC staple.",
